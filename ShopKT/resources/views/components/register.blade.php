<div class="register text-center" id="register">
   <div class="container">
       <h3 class="register-title">Đăng ký trở thành cộng tác viên</h3>
       ...
       <div class="row">
        <div class="col-lg-10 m-auto">
            <form class="row mt-4" action="">
                ...
                <div class="mt-4">
                    <button class="btn btn-danger px-5">Gửi đi</button>
                </div>
            </form>
        </div>
       </div>
       <h5 class="register-sub2 mt-4">Chuyên viên của chúng tôi sẽ liên hệ sớm với bạn</h5>
   </div>
</div>