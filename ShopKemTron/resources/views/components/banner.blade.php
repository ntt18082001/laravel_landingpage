        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-sm-center text-md-start">
                ...
                <p class="paragraph">
                    ...
                    nó có khả năng làm bật tone da hiệu quả, nhanh chóng, chống nắng cực tốt, dưỡng ẩm, mịn da. Và hơn
                    hết, sản phẩm an toàn tuyệt đối cho da nhờ được sản xuất từ các thành phần tự nhiên.
                </p>
                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalOrder">
                    Mua ngay!
                </button>
            </div>
        </div>
